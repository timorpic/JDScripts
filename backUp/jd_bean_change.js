...
[task_local]
#京东资产变动通知
30 9 * * * jd_bean_change.js, tag=京东资产变动通知, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon===============
[Script]
cron "30 9 * * *" script-path=jd_bean_change.js, tag=京东资产变动通知
=============Surge===========
[Script]
京东资产变动通知 = type=cron,cronexp="30 9 * * *",wake-system=1,timeout=3600,script-path=jd_bean_change.js

============小火箭=========
京东资产变动通知 = type=cron,script-path=jd_bean_change.js, cronexpr="30 9 * * *", timeout=3600, enable=true
 */
...
const $ = new Env('京东资产变动通知_Timorpic');
