...
!(async () => {
  ...
  if (!res) {
    $.http.get({
      url: 'https://sub.timor.icu/JDscripts/ys.json'
...
function active(shareId = null, type = true) {
  return new Promise(resolve => {
    $.post(taskUrl(`presaleGift/active`, {
      "attributes": {
        "activeId": "presaleGiftD9gBzawG",
        "shareId": shareId,
        "lkToken": $.lkToken,
        "valueDay": new Date().Format("yyyyMMdd")
      }
    }), async (err, resp, data) => {
      try {
        if (err) {
...
function lottery() {
  return new Promise(resolve => {
    $.post(taskUrl(`presaleGift/lottery`, {
      "attributes": {
        "activeId": "presaleGiftD9gBzawG",
        "joinId": $.joinId,
        "lotteryForm": 0
...
function share(shareId) {
  return new Promise(resolve => {
    $.post(taskUrl(`presaleGift/share`, {
      "attributes": {
        "activeId": "presaleGiftD9gBzawG",
        "joinId": $.joinId,
        "shareId": shareId,
