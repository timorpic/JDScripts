...
async function receiveGoldCoin() {
  ...
  $.goldCoinData = await smtgReceiveCoin({
    "type": 0
  });
...
async function barGain() {
  let res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/jd_barGain.json'),
    res2 = [];
...
async function bigWinner() {
  ...
  if (!res) {
    $.http.get({
      url: 'https://purge.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/bigWinner.json'
